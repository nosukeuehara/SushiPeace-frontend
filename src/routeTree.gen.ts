...
const NewSushiGroupRoomIdroomIdIndexRoute = NewSushiGroupRoomIdroomIdIndexRouteImport.update({
  id: "/new-sushi/group/$roomId/(roomId)/",
  path: "/new-sushi/group/$roomId/",
  getParentRoute: () => rootRouteImport,
} as any);
const NewSushiGroupRoomIdshareShareRoute = NewSushiGroupRoomIdshareShareRouteImport.update({
  id: "/new-sushi/group/$roomId/(share)/share",
  path: "/new-sushi/group/$roomId/share",
  getParentRoute: () => rootRouteImport,
} as any);
const NewSushiGroupRoomIdresultResultRoute = NewSushiGroupRoomIdresultResultRouteImport.update({
